...
public final class Short extends Number implements Comparable<Short>, Constable {
    ...
    @PolyValue
    @PolySigned
    public static Short valueOf(@PolyIndex @PolyValue @PolySigned short s);
    ...
    @PolyValue
    @PolySigned
    public Short(@PolyIndex @PolyValue @PolySigned short value) {
    }
    ...
    @PolyValue
    @PolySigned
    public short shortValue(@PolyIndex @PolyValue @PolySigned Short this);
    ...
    @PolyValue
    @PolySigned
    public int intValue(@PolyIndex @PolyValue @PolySigned Short this);
    ...
    @PolyValue
    @PolySigned
    public long longValue(@PolyIndex @PolyValue @PolySigned Short this);
