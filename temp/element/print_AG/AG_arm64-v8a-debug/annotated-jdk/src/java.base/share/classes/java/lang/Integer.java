...
public final class Integer extends Number implements Comparable<Integer>, Constable, ConstantDesc {
    ...
    @PolyValue
    @PolySigned
    public static Integer valueOf(@PolyIndex @PolyValue @PolySigned int i);
    ...
    @PolyValue
    @PolySigned
    public Integer(@PolyIndex @PolyValue @PolySigned int value) {
    }
    ...
    @PolyValue
    @PolySigned
    public int intValue(@PolyIndex @PolyValue @PolySigned Integer this);
    ...
    @PolyValue
    @PolySigned
    public long longValue(@PolyIndex @PolyValue @PolySigned Integer this);
