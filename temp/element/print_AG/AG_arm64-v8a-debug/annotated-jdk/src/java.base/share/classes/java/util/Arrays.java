...
public class Arrays {
    ...
    @MinLen(2)
    public static String toString(@PolyMustCall @PolyNull @PolySigned @PolyInterned Object @PolyMustCall @Nullable [] a);

    @SideEffectFree
    @MinLen(2)
    public static String deepToString(@PolyMustCall @PolyNull @PolySigned @PolyInterned Object @PolyMustCall @Nullable [] a);
