...
public final class Long extends Number implements Comparable<Long>, Constable, ConstantDesc {
    ...
    @PolyValue
    @PolySigned
    public static Long valueOf(@PolyValue @PolySigned long l);
    ...
    @PolyValue
    @PolySigned
    public Long(@PolyIndex @PolyValue @PolySigned long value) {
    }
    ...
    @PolyValue
    @PolySigned
    public long longValue(@PolyIndex @PolyValue @PolySigned Long this);
